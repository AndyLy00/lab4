...
public class AMD extends Processor {
    ...
    public AMD(String frequency, int cores, int cache, String architecture, String typeOfCPU, String CPUModel, String CPUCompany, double price, String madein, String shop) {
